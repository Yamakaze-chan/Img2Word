try:
    ...
    from lib.vietocr.model.backbone.cnn import CNN
    from lib.vietocr.model.seqmodel.transformer import LanguageTransformer
    from lib.vietocr.model.seqmodel.seq2seq import Seq2Seq
    from lib.vietocr.model.seqmodel.convseq2seq import ConvSeq2Seq
